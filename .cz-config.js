module.exports = {
  types: [
    ...
    {
      value: "style",
      name: "style: Cambios que no afectan al significado del código (espacios en blanco, formato, punto y coma que faltan, etc.)",
    },
    {
      value: "refactor",
      name: "refactor: Cambios en el código que no corrige errores ni añade características",
    },
    {
      value: "perf",
    ...
    {
      value: "chore",
      name: "chore: Cambios en el proceso de construcción o herramientas auxiliares y bibliotecas como la generación de documentación",
    },
